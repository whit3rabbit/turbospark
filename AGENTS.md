...
8. `crates/gpu` is the one crate with a hard platform gate: everything in
   ...
   `dequant_q8_0_gemv_simd` (GGUF Q8_0, also with a resident variant, and
   port-local because Swift has no GGUF intake), `router_gemv_gemma4_r4`,
