...
8. `crates/gpu` is the one crate with a hard platform gate: everything in
   ...
   Q4_K, each also with a resident variant, and port-local because Swift
   has no GGUF intake), `router_gemv_gemma4_r4`,
