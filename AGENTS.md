...
8. `crates/gpu` is the one crate with a hard platform gate: everything in
   ...
   not measured the symmetry cannot reach it) plus `embed_lookup_int1`
   (the checkpoint quantizes its embedding TABLE at one bit too, so this
