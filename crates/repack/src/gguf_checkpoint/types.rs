...
pub fn dtype_tag_for_ggml_type(ggml_type: u32) -> Option<u8> {
    use crate::resident_writer::{
        ...
        DTYPE_GGUF_IQ4_NL, DTYPE_GGUF_IQ4_XS, DTYPE_GGUF_Q2_0, DTYPE_GGUF_Q2_K, DTYPE_GGUF_Q3_K,
        DTYPE_GGUF_Q4_0, DTYPE_GGUF_Q4_K, DTYPE_GGUF_Q5_K, DTYPE_GGUF_Q6_K, DTYPE_GGUF_Q8_0,
    };
