...
use crate::real_forward_utils::{entry, layer_tensor, norm_view, ring_spans};
...
impl RealForwardRunner {
    ...
    pub(crate) fn encode_gemma4_layer_attn_and_router_batched(
        ...
        // K and V write STRAIGHT into the cache. A sliding-window layer's
