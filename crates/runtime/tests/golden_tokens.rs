...
use turbospark_repack::{build_synthetic_gemma4_install, build_synthetic_gemma4_moe_install};
...
fn temp_dir() -> PathBuf {
    ...
    let dir = std::env::temp_dir().join(format!("turbospark-golden-{}-{n}", std::process::id()));
