# Archived module guide: ffi

This is the detailed module guide moved from `crates/ffi/AGENTS.md`. The active entry point is the short guide at `crates/ffi/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
