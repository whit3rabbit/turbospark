# Archived module guide: tokenizer

This is the detailed module guide moved from `crates/tokenizer/AGENTS.md`. The active entry point is the short guide at `crates/tokenizer/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
