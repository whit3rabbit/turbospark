# Archived module guide: server

This is the detailed module guide moved from `crates/server/AGENTS.md`. The active entry point is the short guide at `crates/server/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
