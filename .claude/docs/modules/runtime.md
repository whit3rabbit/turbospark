# Archived module guide: runtime

This is the detailed module guide moved from `crates/runtime/AGENTS.md`. The active entry point is the short guide at `crates/runtime/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
