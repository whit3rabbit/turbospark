# Archived module guide: window-fit

This is the detailed module guide moved from `crates/window-fit/AGENTS.md`. The active entry point is the short guide at `crates/window-fit/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
