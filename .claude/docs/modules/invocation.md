# Archived module guide: invocation

This is the detailed module guide moved from `crates/invocation/AGENTS.md`. The active entry point is the short guide at `crates/invocation/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
