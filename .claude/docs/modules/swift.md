# Archived module guide: swift

This is the detailed module guide moved from `swift/AGENTS.md`. The active entry point is the short guide at `swift/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
