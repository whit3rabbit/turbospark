# Archived module guide: catalog

This is the detailed module guide moved from `crates/catalog/AGENTS.md`. The active entry point is the short guide at `crates/catalog/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
