# Archived module guide: vision-io

This is the detailed module guide moved from `crates/vision-io/AGENTS.md`. The active entry point is the short guide at `crates/vision-io/AGENTS.md`; this page preserves the deeper directory map, commands, gotchas, and evidence notes for on-demand reading.
