# turbospark-bench benchmark reference

This is the detailed benchmark guide moved from `crates/bench/AGENTS.md`.
The active crate entry point is short and points here, the canonical benchmark
docs, and the per-family gate pages.
...
|   +-- bonsai2_memory_oracle.rs # Memory oracle for Bonsai-2 27B (Hadamard-folded 2-bit)
|   +-- bonsai2_quality_gate.rs  # Quality gate for Bonsai-2 27B (Hadamard-folded 2-bit)
