# Engineering guardrails and gotchas

These are durable implementation guardrails moved out of the always-loaded root instructions. Read the relevant item before changing the subsystem it names. Historical dates and measurements are retained here only when they explain a safety boundary or a measurement limitation.
